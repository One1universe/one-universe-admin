...
//       isDropDown: false,
//       activeImage: "/dashboard/active/booking-management.svg",
//       inActiveImage: "/dashboard/inactive/booking-management.svg",
//     },
//     {
//       id: 4,
...
//       isDropDown: false,
//       activeImage: "/dashboard/active/user-role-management.svg",
//       inActiveImage: "/dashboard/inactive/user-role-management.svg",
//     },
//     {
//       id: 6,
...
//       {/* Desktop Sidebar */}
//       <section className="w-[260px] py-3.5 px-3.5 h-screen hidden md:flex flex-col justify-between bg-[#FFFDFD] border border-[#FFF9F9]">
//         <SidebarContent />
//       </section>
...
//         {/* Desktop Header */}
//         <header className="border-b border-[#FFF9F9] hidden md:flex items-center justify-between px-8 h-[80px]">
...
//         {/* Mobile Header */}
//         <header className="flex md:hidden items-center justify-between px-8 h-[48px] border-b border-[#FFF9F9]">
//           <Image
//             src="/logo/one-universe.svg"
//             alt="Auth Logo"
//             width={120}
  ...
  return (
    <main className="flex h-screen overflow-hidden">
      ...
      <section className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <section className="flex-1 overflow-y-auto px-2.5 md:px-8 mt-[25px]">
          {children}
        </section>
      </section>
    </main>
